...
func (_mock *MockMailer) Send(ctx context.Context, email common.Email) error {
	...
	var r0 error
	if returnFunc, ok := ret.Get(0).(func(context.Context, common.Email) error); ok {
...
func (_c *MockMailer_Send_Call) Run(run func(ctx context.Context, email common.Email)) *MockMailer_Send_Call {
	_c.Call.Run(func(args mock.Arguments) {
		...
		var arg1 common.Email
		if args[1] != nil {
			arg1 = args[1].(common.Email)
		}
		run(
			arg0,
			arg1,
...
func (_c *MockMailer_Send_Call) RunAndReturn(run func(ctx context.Context, email common.Email) error) *MockMailer_Send_Call {
	_c.Call.Return(run)
	return _c
}
