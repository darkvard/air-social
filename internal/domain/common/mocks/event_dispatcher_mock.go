...
func (_mock *MockEventDispatcher) Dispatch(ctx context.Context, event common.Event) error {
...
func (_c *MockEventDispatcher_Dispatch_Call) RunAndReturn(run func(ctx context.Context, event common.Event) error) *MockEventDispatcher_Dispatch_Call {
	_c.Call.Return(run)
	return _c
}
