...
func (_mock *MockEventPublisher) Publish(ctx context.Context, event common.Event) error {
...
func (_c *MockEventPublisher_Publish_Call) RunAndReturn(run func(ctx context.Context, event common.Event) error) *MockEventPublisher_Publish_Call {
	_c.Call.Return(run)
	return _c
}
